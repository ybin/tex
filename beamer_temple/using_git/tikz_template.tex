...
{\end{minipage}\end{lrbox}
  ...
  \begin{tikzpicture}
    ...
    % draw the content
    \node[xshift=\boxroundness,yshift=\boxroundness,inner sep=0pt,outer sep=0pt,anchor=south west]
...
\begin{center}
  \begin{shadowblock}{0.7\textwidth}{yellow!50}{black!50}
  \centering\Large
  \texttt{#1}
  \end{shadowblock}
\end{center}
...
{\begin{center}\begin{shadowblock}{0.7\textwidth}{gray!20}{red}}
